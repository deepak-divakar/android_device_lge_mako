...
/dev/block/platform/msm_sdcc.1/by-name/userdata     /data           ext4    rw,nodev,noatime,noauto_da_alloc,nobarrier                              wait,check,formattable,encryptable=/dev/block/platform/msm_sdcc.1/by-name/metadata
